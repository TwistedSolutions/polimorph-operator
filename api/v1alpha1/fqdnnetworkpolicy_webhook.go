...
//+kubebuilder:webhook:path=/mutate-twistedsolutions-se-v1alpha1-fqdnnetworkpolicy,mutating=true,failurePolicy=fail,sideEffects=None,groups=twistedsolutions.se,resources=fqdnnetworkpolicies,verbs=create;update,versions=v1alpha1,name=mfqdnnetworkpolicy.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-twistedsolutions-se-v1alpha1-fqdnnetworkpolicy,mutating=false,failurePolicy=fail,sideEffects=None,groups=twistedsolutions.se,resources=fqdnnetworkpolicies,verbs=create;update,versions=v1alpha1,name=vfqdnnetworkpolicy.kb.io,admissionReviewVersions=v1
