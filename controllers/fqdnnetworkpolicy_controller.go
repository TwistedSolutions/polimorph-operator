...
//+kubebuilder:rbac:groups=fqdn.twistedsolutions.se,resources=fqdnnetworkpolicies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=fqdn.twistedsolutions.se,resources=fqdnnetworkpolicies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=fqdn.twistedsolutions.se,resources=fqdnnetworkpolicies/finalizers,verbs=update
